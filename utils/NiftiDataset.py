...
def create_SECT_list(data_path):
    ...
    data_list = os.path.join(os.getcwd(),data_path + 'DECT/')
    data_list = os.listdir(data_list)

    list_all = [{'data': os.path.join(data_path + 'DECT/', path), 'label': os.path.join(data_path + 'SECT/', path)} for path in data_list]
